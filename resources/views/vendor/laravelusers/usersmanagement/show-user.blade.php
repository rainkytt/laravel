                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-3 col-sm-4 col-md-4 col-lg-3">
                                {!! Form::open(array('url' => 'users/' . $user->id, 'class' => 'form-inline')) !!}
                                    ...
                                    {!! Form::button(trans('laravelusers::laravelusers.buttons.delete-user'), array('class' => 'btn btn-danger btn-md btn-block','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Kustuta kasutaja', 'data-message' => 'Oled sa kindel, et soovid kasutaja kustutada?')) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
